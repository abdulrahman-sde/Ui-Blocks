        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7 px-5 sm:px-8 lg:px-12">
          ...
          <div>
            <div className="relative aspect-[329/246] rounded-2xl overflow-hidden bg-[#1a1d2e] group cursor-pointer">
              ...
              <div className="absolute bottom-4 left-4">
                <div className="bg-white h-9 w-9 rounded-full flex items-center justify-center transition-all duration-300 ease-in-out group-hover:w-[148px] group-hover:px-3 overflow-hidden">
                  <span className="flex items-center gap-2">
                    <span className="text-[13px] font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 delay-100">
                      Learn more
                    </span>
                    <span className="flex-shrink-0 transition-transform duration-300 ease-in-out group-hover:rotate-0 -rotate-45">
                      {linkSvg}
                    </span>
                  </span>
                </div>
            ...
            <p className="text-[13px] sm:text-[14px] text-gray-600 mt-4 leading-relaxed">
              Winner of Site of the Month 2025 &mdash; an interactive 3D showcase driving record engagement
            </p>
          ...
          <div>
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-[#6b6b6b] group cursor-pointer">
              ...
              />
              <div className="absolute bottom-4 left-4">
                <div className="bg-gray-900 h-9 w-9 rounded-full flex items-center justify-center transition-all duration-300 ease-in-out group-hover:w-[168px] group-hover:px-3 overflow-hidden">
                  <span className="flex items-center gap-2">
                    ...
                    <span className="flex-shrink-0 text-white transition-transform duration-300 ease-in-out group-hover:rotate-0 -rotate-45">
                      <ArrowRight size={14} />
                    </span>
                  </span>
                </div>
